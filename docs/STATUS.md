...
| Python API | Version 0.10 retains the passive post-handoff readiness gate and adds deterministic complete-PICkit composition with explicit derived/pre-calibration provenance | Portable tests, full-image loader emulation, factory 2.06 golden reconstruction, section invariants, hashes, and preserved serial 5215 evidence |
