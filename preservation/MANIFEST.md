...
The five files listed in `PENDING_UPLOADS.md` are catalogued below but are awaiting direct GitHub upload. Their recorded hashes were calculated from the recovered originals before publication.
