...
A disconnected, crashed, unpowered, or removed OpenMaxFire device must not prevent normal factory operation. Home Assistant, Wi-Fi, Ethernet, MQTT, the ESP32, and the Linux service are optional supervisory layers, never required safety controllers.
